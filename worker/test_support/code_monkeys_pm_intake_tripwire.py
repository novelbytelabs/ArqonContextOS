...
checks = [
    ...
    ("validates handoff artifact type role source path", "validateExpectedHandoffArtifact" in pm and "PM_INTAKE_HANDOFF_ARTIFACT_TYPE_MISMATCH" in pm and "PM_INTAKE_HANDOFF_ARTIFACT_SOURCE_MISMATCH" in pm),
    ...
    ("offline type/source tamper tests", "pm-intake-type-tamper-0001" in offline and "pm-intake-source-tamper-0001" in offline),
