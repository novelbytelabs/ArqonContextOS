...
checks = [
  ...
  ("route-only artifacts", all(a in flows for a in ['"execution_report"', '"command_log"', '"evidence_manifest"']) and "FLOW_ARTIFACT_ROUTE_REQUIRED" in flows),
  ...
  ("forbidden claim guard", "HELPER_EXECUTION_REPORT_FORBIDDEN_CLAIM_INCLUDED" in handler),
