...
FILES = [
  ...
  "worker/src/index.ts", "worker/src/pm_handoff.ts", "worker/src/pm_intake.ts", "worker/src/pm_specify.ts",
  "worker/src/policy.ts", "worker/src/projects.ts", "worker/src/repo_store.ts", "worker/src/response.ts",
  "worker/src/science.ts", "worker/src/science_share.ts", "worker/src/messages.ts", "worker/src/notes.ts", "worker/src/types.ts",
  ...
  "worker/tsconfig.json", "worker/tsconfig.smoke.json", "worker/package.json", "openapi/arqon_contextos.openapi.yaml",
...
def main() -> None:
    ...
    manifest = {"schema_version": "pm_specify_audit_bundle.v0.1", "commit": commit, "required_status_labels": LABELS, "files": records}
    out = root / "temps" / f"pm_specify_audit_bundle_{commit[:12]}.zip"
